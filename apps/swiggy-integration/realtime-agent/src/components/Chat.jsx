/* Minimal room chat panel for sending manual chat-msg events into Daily. */
...
export default function Chat() {
  ...
  const handleChange = (e) => {
    /* Keep the uncontrolled chat input out of the rest of the call state. */
    setInputValue(e.target.value);
  };

  const handleSubmit = (e) => {
    /* Ignore empty messages so the hosted agent only sees meaningful chat turns. */
    e.preventDefault();
